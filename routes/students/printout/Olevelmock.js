...
const AUTH_INFO = "AUT.Nº: GEN-430/23/MINESEC/SG/DESG/...";

const PASSING_GRADES = new Set(["A", "B", "C"]); // adjust if D is considered pass
...
function drawHeaderContents(doc, options = {}) {
  ...
  doc.save();
  doc.roundedRect(leftX, addrY - 4, width, 44, 4).fillAndStroke("#f0f8ff", "#005566");
